...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 to-gray-950 px-4">
      <div className="bg-gray-900 p-8 rounded-xl shadow-xl max-w-md w-full border border-purple-800 relative">
        
        {/* 🏠 Home Button */}
        <Link
          to="/"
          className="absolute top-4 right-4 text-sm text-purple-400 hover:text-purple-300 hover:underline"
        >
          🏠 Home
        </Link>
