        ...
        <>
            {
                ...
                auth ? <UnAuthorized /> : (
                    <div className='bg-[#15082b] w-full   border-purple-400 shadow shadow-[#42207d] text-white'>
                        <div className='w-full flex justify-between p-3'>
                            <h1 className="text-2xl font-bold border-t border-b text-purple-400">SmartExam</h1>
                            <div>
