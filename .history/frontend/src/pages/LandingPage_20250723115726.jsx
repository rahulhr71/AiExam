  ...
  return (
    <div className="bg-gray-950 text-white font-sans">
      ...
      <footer id="contact" className="py-12 text-center bg-gray-900 border-t border-gray-800">
        <h4 className="text-xl font-semibold mb-2">Built with ❤️ by SmartExam Team</h4>
        <p className="text-sm text-gray-400">© 2025 All rights reserved.</p>
        <p className="mt-4">
          <a href="mailto:support@smartexam.ai" className="text-purple-300 hover:underline">support@smartexam.ai</a>
        </p>
      </footer>
    </div>
  );
