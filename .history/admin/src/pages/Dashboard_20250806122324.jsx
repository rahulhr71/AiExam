...
import { BellIcon,ArrowLeftIcon, ShieldCheckIcon,  AcademicCapIcon,Cog6ToothIcon, } from '@heroicons/react/24/outline';
const Dashboard = () => {
...
const AdminActionsCard = () => {
  return (
    <div className="mt-4 p-4 w-200  m-auto flex flex-col gap-4 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center space-x-4 cursor-pointer hover:bg-gray-50 p-2 rounded-md transition">
        <ShieldCheckIcon className="h-8 w-8 text-blue-600" />
        <span className="text-lg font-semibold text-gray-800">View All Teachers</span><ArrowLeftIcon/>
      </div>
      <div className="flex items-center space-x-4 cursor-pointer hover:bg-gray-50 p-2 rounded-md transition">
        <ShieldCheckIcon className="h-8 w-8 text-blue-600" />
