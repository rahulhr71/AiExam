        ...
        <div className=''>
            ...
            <div className='  absolute top-0 right-0 w-[calc(100%-240px)]  '>
                ...
                <div className='p-4'>
                    ...
                    <div className='mt-4 p-4 w-200 h-90 m-auto flex flex-col gap-4 bg-white rounded-lg shadow-md'>
                        ...
                        <div className="flex items-center space-x-2 cursor-pointer mt-4">
                            <ShieldCheckIcon className="h-10 w-10 text-blue-600" />
                            <span className=" text-gray-700 font-medium text-2xl ">Add class</span>
                        </div>
                    </div>
                </div>
            </div>
...
const AdminActionsCard = () => {
  return (
    <div className="mt-6 p-6 w-full max-w-md mx-auto bg-white rounded-xl shadow-lg space-y-6">
      {/* Add Teacher */}
