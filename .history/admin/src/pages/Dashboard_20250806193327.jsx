    ...
    <div>
      ...
      <div className='mt-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          ...
          <Link to='/dashboard/addteacher'>  <ActionButton label="Add Teacher" onClick={() => onActionClick('addTeacher')} /> </Link>
          <Link to='/dashboard/addstudent'><ActionButton label="Add Student" onClick={() => onActionClick('addStudent')} /></Link>
          <Link to='/dashboard/addclass'><ActionButton label="Add Class" onClick={() => onActionClick('addClass')} /></Link>
        </div>
      </div>
    </div>
  );
