...
const AdminActionsCard = () => {
  ...
  return (
    <div className="mt-4 p-4 w-200  m-auto flex flex-col gap-4 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center space-x-4 cursor-pointer hover:bg-gray-50 p-2 rounded-md transition" data-value="Add Teacher" onClick={(e)=>console.log(e.target.value)}>
