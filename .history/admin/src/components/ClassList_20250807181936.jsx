    ...
    return (
        <div className="max-w-6xl mx-auto mt-10 px-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-6 gap-4">
                <h2 className="text-2xl font-bold text-purple-700">Classes List</h2>
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-200 rounded-md shadow-sm">
                    <thead>
                        <tr>
                            <th className="bg-purple-700 text-white px-4 py-3 text-left text-sm">Class</th>
                            <th className="bg-purple-700 text-white px-4 py-3 text-left text-sm">Section</th>
                            <th className="bg-purple-700 text-white px-4 py-3 text-left text-sm">Class Teacher</th>
                            <th className="bg-purple-700 text-white px-4 py-3 text-left text-sm">Strength</th>
                        </tr>
                    </thead>
                    <tbody>
