...
import { HomeIcon,AcademicCapIcon } from '@heroicons/react/24/solid';
const Sidebar = () => {
  return (
    <div className='fixed h-[100vh] w-60 bg-[#152259]'>
        ...
        <div className='m-auto bg-red-600 w-[90%]  mt-4 '>
           <ul className='flex flex-col gap-2'>
            ...
            <li className='bg-green-400 w-full p-2 flex gap-2 text-white'><AcademicCapIcon className="h-6 w-6 text-white" /><span>Dashboard</span></li>
