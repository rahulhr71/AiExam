...
const TeachersList = () => {
    ...
    // Get unique subjects from dummy data
    ...
    return (
        <div className="max-w-6xl mx-auto mt-10 px-4">
            <div className="flex flex-col md:flex-row items-center justify-between mb-6 gap-4">
                <h2 className="text-2xl font-bold text-blue-700">Teachers List</h2>
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-200 rounded-md shadow-sm">
                    <thead>
                        <tr>
                            <th className="bg-blue-700 text-white px-4 py-3 text-left text-sm">Name</th>
                            <th className="bg-blue-700 text-white px-4 py-3 text-left text-sm">Email</th>
                            <th className="bg-blue-700 text-white px-4 py-3 text-left text-sm">Subject</th>
                            <th className="bg-blue-700 text-white px-4 py-3 text-left text-sm">Phone</th>
                        </tr>
                    </thead>
                    <tbody>
